(defproject metronome "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "metronome.core/on-js-reload"
                ...
                :compiler {:main metronome.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/metronome.js"
